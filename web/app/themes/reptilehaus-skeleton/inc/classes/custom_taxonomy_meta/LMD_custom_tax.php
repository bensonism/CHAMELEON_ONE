...
CALL IN THEME LIKE THIS

$cats = get_the_category();
foreach ($cats as $coolCat) {
	$dasCat = $coolCat->cat_ID;
}
$saved_data = get_tax_meta($dasCat,'image_field_id');
//print_r($saved_data);
...
// //Image field
$my_meta->addImage('cat_hero_image',array('name'=> 'Category Hero Image '));
$my_meta->addText('cat_hero_header',array('name'=> 'Category Hero Heading'));
$my_meta->addText('cat_hero_subheader',array('name'=> 'Category Hero Sub-Heading'));
$my_meta->addText('cat_intro_header',array('name'=> 'Category Intro Header'));
$my_meta->addWysiwyg('cat_intro_text',array('name'=> 'Category Intro Text'));
